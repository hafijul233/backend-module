...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card">
{{--                {!! \Html::cardHeader(__('general.preference.permissions.index.title'),
                        __('general.preference.permissions.icon'),
                         __('general.preference.permissions.index.detail')) !!}--}}
                <div class="card-body">
                    ...
                    {!! $permissions->onEachSide(2)->appends(request()->query())->links() !!}
                </div>
            </div>
        </div>
    </div>
